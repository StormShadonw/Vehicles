	...
	public class UsersController : Controller
	{
		...
		public async Task<IActionResult> AddVehicleImage(VehiclePhotoViewModel model)
		{
			if(ModelState.IsValid)
			{
				...
				_context.Vehicles.Update(vehicle);
				await _context.SaveChangesAsync();
				return RedirectToAction("EditVehicle", new {id = vehicle.Id});
			}
			return View(model);
		}
		...
		public async Task<IActionResult> AddHistory(HistoryViewModel model)
		{
			if (ModelState.IsValid)
			{
				...
				return RedirectToAction("DetailsVehicle", new {id = vehicle.Id});
			}
		...
		public async Task<IActionResult> EditHistory(int? id, HistoryViewModel historyViewModel)
		{
			if (ModelState.IsValid)
			{
					...
					history.UpdatedBy = Environment.UserName;
					_context.Histories.Update(history);
					await _context.SaveChangesAsync();
					return RedirectToAction("DetailsVehicle", new { id = historyViewModel.VehicleId });
			}
		...
		public async Task<IActionResult> AddDetail(DetailViewModel detailViewModel)
		{
			if (ModelState.IsValid)
			{
				...
				return RedirectToAction("DetailsHistory", new { id = detailViewModel.HistoryId });
			}
		...
		public async Task<IActionResult> EditDetail(int? id, DetailViewModel detailViewModel)
		{
			if (ModelState.IsValid)
			{
				...
				detail.UpdatedBy = Environment.UserName;
